    ...
    <footer className="invert-zone bg-ink text-paper">
      <div className="mx-auto max-w-screen-xl px-4 py-12 lg:py-16">
        <p
          ...
          style={{ fontSize: "clamp(2.5rem, 12vw, 8rem)", letterSpacing: "-0.02em" }}
        >
          {restaurant.name}
        </p>

        <div className="mt-10 grid grid-cols-1 gap-6 border-t border-paper/30 pt-8 font-mono text-[11px] tracking-[0.2em] uppercase sm:grid-cols-2 lg:grid-cols-4">
